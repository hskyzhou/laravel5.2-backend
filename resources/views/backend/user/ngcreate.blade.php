            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="form-group form-md-line-input has-success">
                  ...
                  <div class="col-md-8">
                    <select id="select2-multiple-input-lg" class="form-control input-lg select2-multiple" multiple  name="roles[]">
                ...
                <div class="row">
                  <button class="btn btn-success col-md-offset-2">添加</button>
                </div>
              </div>

              <div class="col-md-8">
                <div class="row margin-bottom-20">
                  <a class="btn btn-info" ng-click="selectAll()">全选</a>
                  <a class="btn btn-info" ng-click="selectInverse()">反选</a>
                </div>
                @if($permissions)
