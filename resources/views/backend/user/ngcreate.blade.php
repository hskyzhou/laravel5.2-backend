              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <div class="form-group form-md-line-input has-success">
                    ...
                    <div class="col-md-8">
                      <select id="select2-multiple-input-lg" class="form-control input-lg select2-multiple" name="role[]" multiple>
                ...
                <div class="col-md-8">
                  <div class="row margin-bottom-10">
                    ...
                    <a class="btn btn-success" ng-click="notSelectAll()">反选</a>
                  </div>
                  @if($permissions)
                          ...
                          @if(is_array($permission))
                            @foreach($permission as $sonPermission)
                              <label style="margin-left:30px;">
                                <input type="checkbox" class="icheck soncheckbox" data-checkbox="icheckbox_square-grey" value="{{$sonPermission['value']}}" name="permission[]">{{$sonPermission['name']}}
                              </label>
                            @endforeach
                          @endif   
                        </div>
